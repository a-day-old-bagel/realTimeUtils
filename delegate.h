...
namespace rtu {
    ...
    */
    ...
    #define RTU_MTHD_DLGT(func, instRef) (NewDelegate(func).Create<func>(instRef)) // deletage to member method
  #endif
  #ifndef RTU_FUNC_DLGT
    #define RTU_FUNC_DLGT(func) (NewDelegate_NoClass(func).CreateForFunction<func>()) // delegate to normal function
  #endif
